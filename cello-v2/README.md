...
> Local workspace note: this fork is used as an infrastructure substrate for COGNUSpb orchestration experiments.
> Reference docs in this workspace: `docs/new-orchestrator-overview.md`, `docs/entregas/README.md`, `docs/entregas/roadmap-epicos.md`.
> This note adds local context and does not replace upstream Hyperledger Cello documentation.
