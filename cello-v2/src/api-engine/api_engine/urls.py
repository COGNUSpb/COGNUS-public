...
from api.routes.blueprint.views import BlueprintViewSet
from api.routes.runbook.views import RunbookViewSet
...
router.register("blueprints", BlueprintViewSet, basename="blueprint")
