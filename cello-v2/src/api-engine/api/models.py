...
# Modelo para persistência de eventos do dashboard
class EventLog(models.Model):
    timestamp = models.DateTimeField(auto_now_add=True)
    level = models.CharField(max_length=16, help_text="Nível do evento (info, warning, error)")
...
class Node(models.Model):
    admin_cert = models.CharField(
        help_text="Caminho do certificado de admin do orderer",
        max_length=512,
        null=True,
        blank=True,
        default=None,
    ...
    admin_key = models.CharField(
        help_text="Caminho da chave privada de admin do orderer",
        max_length=512,
        null=True,
        blank=True,
        default=None,
...
## Removido: duplicidade de EventLog
    status = models.CharField(
